...
CREATE TABLE IF NOT EXISTS `pre_go_crm_user_c` (
    ...
    `usr_email` varchar(255) NOT NULL DEFAULT '' COMMENT 'Email',
    `usr_phone` varchar(15) NOT NULL DEFAULT '' COMMENT 'Phone Number',
    `usr_username` varchar(50) NOT NULL DEFAULT '' COMMENT 'Username',
    ...
    `usr_create_ip_at` varchar(255) NOT NULL DEFAULT '' COMMENT 'Creation IP',
    `usr_last_login_at` int(11) NOT NULL DEFAULT '0' COMMENT 'Last Login Time',
    `usr_last_login_ip_at` varchar(255) NOT NULL DEFAULT '' COMMENT 'Last Login IP',
